    ...
    <section id="academics" aria-labelledby="academics-title" className="text-center">
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {departments.map((dept) => (
          <Card
            key={dept.name}
            className="group transform-gpu bg-card text-left transition-all duration-300 border border-primary shadow-lg shadow-primary/20 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/20"
          >
