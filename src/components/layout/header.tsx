...
const Header = () => {
  ...
  return (
    <header className="relative w-full overflow-hidden bg-card">
      {/* Left Watermark Logo */}
      {leftLogo && (
        <div className="pointer-events-none absolute left-0 top-1/2 z-0 hidden h-[400px] w-[400px] -translate-y-1/2 -translate-x-1/3 opacity-5 xl:block">
          <Image
      ...
      {rightLogo && (
        <div className="pointer-events-none absolute right-0 top-1/2 z-0 hidden h-[400px] w-[400px] -translate-y-1/2 translate-x-1/3 opacity-5 xl:block">
          <Image
